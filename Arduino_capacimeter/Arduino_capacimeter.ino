...
#define resistorValue  9770.0F   // change this to whatever resistor value you are using
...
void loop(){
 ...
 // convert milliseconds to seconds ( 10^-3 ) and Farads to microFarads ( 10^6 ),  net 10^3 (1000)  
  ...
  if (microFarads > 1000){
    Serial.print((long)microFarads/1000.0);       // print the value to serial port
  ...
  else
  {
    ...
    nanoFarads = microFarads-11.0;      // multiply by 1000 to convert to nanoFarads (10^-9 Farads)
